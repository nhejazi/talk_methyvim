...
* Efficient Influence Function (EIF):
  $EIF(O_i) = h_n(A,W)(Y - Q_n(A,W)) + (Q_n(A = 1, W) - Q_n(A = 0, W) + \Psi_g(P_n^*))$
...
* Many thanks to the the organizors for the opportunity to speak.

* ...And thank you for your time `r emo::ji('thanks')`
